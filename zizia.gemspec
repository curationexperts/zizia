...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency 'kaminari', '> 1.0'
  ...
  gem.add_development_dependency 'devise', '~> 4.0'
  gem.add_development_dependency 'devise-guests', '~> 0.7'
  gem.add_development_dependency 'factory_bot', '~> 5.0'
  gem.add_development_dependency 'fcrepo_wrapper', '~> 0.9'
  gem.add_development_dependency 'ffaker', '~> 2.0'
  ...
  gem.add_development_dependency 'web-console'
