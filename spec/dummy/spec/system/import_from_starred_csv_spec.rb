...
RSpec.describe 'Importing records from a CSV file', :perform_jobs, clean: true, type: :system, js: true do
  ...
  let(:csv_file) { File.join(fixture_path, 'csv_import', 'good', 'starred_fields.csv') }
  ...
  context 'logged in as an admin user' do
    ...
    context 'using the new UI' do
      ...
      it 'starts the import' do
        ...
        expect(page).to have_content('You sucessfully uploaded this CSV: starred_fields.csv')
        ...
        expect(page).to have_content 'starred_fields.csv'
